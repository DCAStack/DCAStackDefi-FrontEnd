...
import { createStyles, Table, ScrollArea, Group, Button } from "@mantine/core";
...
export function ScheduleTable({ data }: TableScrollAreaProps) {
...
export function UserSchedulesPopulated() {
  return <ScheduleTable data={randomdata.data} />;
}
