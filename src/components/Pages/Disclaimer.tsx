...
const Disclaimer = () => {
    return (
        <div>
            <Title align="center">DCAStack Disclaimer</Title>
            <Space h="xl" />
            The information provided by DCAStack ("we," "us," or "our") on https://www.dcastack.com (the "Site") is for general informational purposes only.
            ...
            adequacy, validity, reliability, availability, or completeness by us. WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR
            THE ACCURACY OR RELIABILITY OF ANY INFORMATION OFFERED BY THIRD-PARTY WEBSITES LINKED THROUGH THE SITE OR ANY WEBSITE OR FEATURE LINKED IN
            ANY BANNER OR OTHER ADVERTISING. WE WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND
