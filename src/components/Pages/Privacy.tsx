...
const Privacy = () => {
    return (
        <div>
            <Title align="center">DCAStack Privacy Policy</Title>
            <Space h="xl" />
            This privacy notice for DCAStack ("Company," "we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process")
            your information when you use our services ("Services"), such as when you:
            Visit our website at https://www.dcastack.com, or any website of ours that links to this privacy notice
            Engage with us in other related ways, including any sales, marketing, or events
            Questions or concerns? Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with
            our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at help@dcastack.com.

            <Space h="xl" />
            <Title align="center" order={4}>SUMMARY OF KEY POINTS</Title>
            <Space h="xl" />
            ...
            how you interact with DCAStack and the Services, the choices you make, and the products and features you use.
            ...
            information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100% secure,
            ...
            <Space h="xl" />
            <Title align="center" order={4}>1. WHAT INFORMATION DO WE COLLECT?</Title>
            <Space h="xl" />
            ...
            obtaining information about us or our products and Services, when you participate in activities on the Services, or otherwise when you contact us.
            ...
            <Space h="xl" />
            <Title align="center" order={4}>2. HOW DO WE PROCESS YOUR INFORMATION?</Title>
            <Space h="xl" />
            ...
            <Space h="xl" />
            <Title align="center" order={4}>3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?
            </Title>
            <Space h="xl" />
            ...
            Consent. We may process your information if you have given us permission (i.e., consent) to use your personal information for a
            ...
            such as to cooperate with a law enforcement body or regulatory agency, exercise or defend our legal rights, or disclose your information as evidence in litigation in which we are involved.
            ...
            and the collection is reasonable for purposes related to investigating a breach of an agreement or a contravention of the laws of Canada or a province
            ...
            <Space h="xl" />
            <Title align="center" order={4}>4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?
            </Title>
            <Space h="xl" />
            ...
            <Space h="xl" />
            <Title align="center" order={4}>5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?
            </Title>
            <Space h="xl" />
            ...
            <Space h="xl" />
            <Title align="center" order={4}>6. HOW LONG DO WE KEEP YOUR INFORMATION?
            </Title>
            <Space h="xl" />
            ...
            When we have no ongoing legitimate business need to process your personal information, we will either delete or anonymize s
            uch information, or, if this is not possible (for example, because your personal information has been stored in backup archives),
            ...
            <Space h="xl" />
            <Title align="center" order={4}>7. HOW DO WE KEEP YOUR INFORMATION SAFE?
            </Title>
            <Space h="xl" />
            ...
            our security and improperly collect, access, steal, or modify your information. Although we will do our best to protect your
            personal information, transmission of personal information to and from our Services is at your own risk. You should only access
            the Services within a secure environment.


            <Space h="xl" />
            <Title align="center" order={4}>8. DO WE COLLECT INFORMATION FROM MINORS?
            </Title>
            <Space h="xl" />
            ...
            dependent’s use of the Services. If we learn that personal information from users less than 18 years of age has been collected,
            we will deactivate the account and take reasonable measures to promptly delete such data from our records.
            If you become aware of any data we may have collected from children under age 18, please contact us at help@dcastack.com.

            <Space h="xl" />
            <Title align="center" order={4}>9. WHAT ARE YOUR PRIVACY RIGHTS?
            </Title>
            <Space h="xl" />
            ...
            you also have the right to complain to your local data protection supervisory authority. Yo
            u can find their contact details here: https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm.
            ...
            If you have questions or comments about your privacy rights, you may email us at help@dcastack.com.


            <Space h="xl" />
            <Title align="center" order={4}>10. CONTROLS FOR DO-NOT-TRACK FEATURES
            </Title>
            <Space h="xl" />
            ...
            <Space h="xl" />
            <Title align="center" order={4}>11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?
            </Title>
            <Space h="xl" />
            ...
            You may contact us by email at help@dcastack.com, or by referring to the contact details at the bottom of this document.
            ...
            between us and each service provider. Each service provider is a for-profit entity that processes the information on our behalf.
            ...
            DCAStack has not disclosed or sold any personal information to third parties for a business or
            commercial purpose in the preceding twelve (12) months. DCAStack will not sell personal information in
            ...
            person about whom we have the information in our system. These verification efforts require us to ask you to
            provide information so that we can match it with information you have previously provided us. For instance,
            depending on the type of request you submit, we may ask you to provide certain information so that we can match
            the information you provide with the information we already have on file, or we may contact you through a
            communication method (e.g., phone or email) that you have previously provided to us. We may also use other
            verification methods as the circumstances dictate.

            We will only use personal information provided in your request to verify your identity or authority to make the request. To the extent possible,
            we will avoid requesting additional information from you for the purposes of verification. However, if we cannot verify your identity from
            the information already maintained by us, we may request that you provide additional information for the purposes of verifying your identity
            ...
            To exercise these rights, you can contact us by email at help@dcastack.com, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.


            <Space h="xl" />
            <Title align="center" order={4}>12. DO WE MAKE UPDATES TO THIS NOTICE?
            </Title>
            <Space h="xl" />
            ...
            <Space h="xl" />
            <Title align="center" order={4}>13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?
            </Title>
            <Space h="xl" />

            If you have questions or comments about this notice, you may email us at help@dcastack.com.
